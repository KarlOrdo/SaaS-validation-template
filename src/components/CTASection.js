    ...
    return(
       <div className="flex justify-center mb-20 mx-3">
            <div className="shadow-2xl rounded-3xl bg-base-200/80 max-w-3xl text-center border-6 border-base-content/10 p-10">
                ...
                <ButtonScrollToPricing text={appConfig.landing.defaultCTAText} styling={"btn-accent rounded-xl shadow-lg text-white shadow-accent/17 font-bold p-5 py-7 text-3xl mt-10"}/>
